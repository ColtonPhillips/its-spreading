...
@onready var additive_blend_light: Sprite2D = $AnimatedSprite2D/AdditiveBlendLight
...
@onready var stats_component: ActorStatsComponent = $StatsComponent
@onready var hurt_sfx: VariablePitchAudioStreamPlayer = $HurtSfx
@onready var kill_sfx: VariablePitchAudioStreamPlayer = $KillSfx
