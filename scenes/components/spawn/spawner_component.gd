...
func spawn(global_spawn_position: Vector2 = global_position, variables: Dictionary = Dictionary(), parent: Node = get_tree().current_scene) -> Node:
...
# Assuming you have a scene named "Enemy.tscn" with a script attached
